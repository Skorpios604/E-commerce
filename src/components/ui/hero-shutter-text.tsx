...
export default function HeroText({
    ...
    return (
      ...
      bg-zinc-950 transition-colors duration-700 ${className}`}
        >
                        ...
                        {characters.map((char, i) => (
                            ...
                            >
                                ...
                                <motion.span
                                    ...
                                    className="text-[13vw] leading-none font-black text-white tracking-tighter"
                                >
                                    {char === " " ? "\u00A0" : char}
                                </motion.span>
                                ...
                                <motion.span
                                    ...
                                    className="absolute inset-0 text-[13vw] leading-none font-black text-emerald-400 z-10 pointer-events-none"
                                ...
                                <motion.span
                                    ...
                                    className="absolute inset-0 text-[13vw] leading-none font-black text-zinc-200 z-10 pointer-events-none"
                                    style={{
